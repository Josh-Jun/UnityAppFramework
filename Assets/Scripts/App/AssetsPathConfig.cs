...
{
    public const string update_progress = "Update/Textures/update_progress";
    public const string UpdateView = "Update/Views/UpdateView";
    ...
    public const string TestThrift = "Table/Thrift/TestThrift";
