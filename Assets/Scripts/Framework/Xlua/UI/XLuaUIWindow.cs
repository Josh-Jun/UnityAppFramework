...
namespace XLuaFrame {
    ...
    public class XLuaUIWindow : UIWindowBase {
        ...
        /// <summary>初始化</summary>
        public XLuaUIWindow InitXlua(string wndName)
        {
            string fileCon = XLuaManager.Instance.LoadLua(wndName);
            InitLuaEnv(fileCon);
            return this;
        }
        /// <summary>初始化</summary>
        ...
        {
            base.InitWindow();
            LuaCallbackPairs[(int)WndLifeCycle.InitWindow]?.Invoke();
        }
        /// <summary>注册事件</summary>
        protected override void RegisterEvent() {
            base.RegisterEvent();
            LuaCallbackPairs[(int)WndLifeCycle.RegisterEvent]?.Invoke();
        }
        /// <summary>打开窗口</summary>
        protected override void OpenWindow() {
            base.OpenWindow();
            LuaCallbackPairs[(int)WndLifeCycle.OpenWindow]?.Invoke();
        }
        /// <summary>关闭窗口</summary>
        protected override void CloseWindow() {
            base.CloseWindow();
            LuaCallbackPairs[(int)WndLifeCycle.CloseWindow]?.Invoke();
        }
        /// <summary>初始化Lua代码</summary>
        public void InitLuaEnv(string luaFileContent) {
        ...
        private void Update() {
            LuaCallbackPairs[(int)WndLifeCycle.Update]?.Invoke();
        }

        private void OnDestroy() {
            LuaCallbackPairs[(int)WndLifeCycle.OnDestroy]?.Invoke();
