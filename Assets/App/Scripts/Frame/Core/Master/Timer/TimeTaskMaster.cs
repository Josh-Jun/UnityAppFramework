...
namespace App.Core.Master
{
    ...
    public class TimeTaskMaster : SingletonMono<TimeTaskMaster>
    {
        ...
        public bool ReplaceTimeTask(int id, Action action, float delayTime, TimeUnit timeUnit = TimeUnit.Second,
            int count = 1)
        {
