...
namespace UnityEngine.UI
{
    ...
    public class DatePicker : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler
    {
        ...
        /// 我属于的日期选择组
        /// </summary>
        [HideInInspector] public DatePickerGroup myGroup;
        /// <summary>
        /// 当选择日期的委托事件
        /// </summary>
        ...
        GameObject SpawnItem(float real_i)
        {
            ...
            if (real_i != 0)
            {
                _item.GetComponent<TextMeshProUGUI>().color =
                    new Color(0, 0, 0, 1 - 0.2f - (Mathf.Abs(real_i) / (_itemNum / 2 + 1)));
            }
            return _item;
        }
        ...
        public void RefreshDateList()
        {
            ...
            for (int i = 0; i < _itemNum; i++)
            {
                ...
                _itemParent.GetChild(i).GetComponent<TextMeshProUGUI>().text = str;
            }
