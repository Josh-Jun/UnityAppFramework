...
namespace AppFramework.Editor
{
    public class Excel2ThriftEditor : EditorWindow
    {
        ...
        public void OnGUI()
        {
            ...
            scrollPosition =
                GUILayout.BeginScrollView(scrollPosition, GUILayout.MaxHeight(240)); //注意：scrollPosition 必须要有，不然会拖动不了
            {
        ...
        private static void ExecuteConvert()
        {
            ...
            string ret =
                Excel2Thrift.Convert.Execute(m_Parm, excelFiles, m_ExportTab, m_ExportExecuteCode, m_ExportCode);
            Debug.Log(ret);
        }
